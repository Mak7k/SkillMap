...
// Если передан параметр limit, используем его (например, для мультисекции)
...
// Выбираем только проекты с ценой
...
// Всегда сортируем по дате создания (новейшие в начале)
$sql .= " ORDER BY p.created_at DESC";

// Применяем лимит только если поиск не активен
if (!$searchActive) {
    if ($customLimit > 0) {
